...
//    }
    ...
    public function node(){
        //this should be jQuery
        if($this->request->is('post')){
            $http = new Client();
            $response = $http->post('http://land.reg:8080/puppeteer', [
            'title' => 'test',
            'body' => 'test body'
            ]);
        }
    ...
    {
        $documentsTableObj = FactoryLocator::get('Table')->get('Documents');
        $documentsEnt = $this->documentsTableObj->newEmptyEntity();
        if ($this->request->is('post')) {
...
//                $postData['upload_file'] = $name;
            ...
            $documents = $this->documentsTableObj->patchEntity($documentsEnt, $file);
        }

        $this->set(compact('documentsEnt', $documentsEnt));
...
//    function __construct(?ServerRequest $request = null, ?Response $response = null, ?string $name = null, ?EventManagerInterface $eventManager = null, ?ComponentRegistry $components = null)
//    {
...
//    }
    ...
    public function beforeFilter(\Cake\Event\EventInterface $event)
    {
        ...
        $this->csvTableObj = FactoryLocator::get('Table')->get('Csv');
    }
...
//        echo $var;
    ...
    public function receiver()
    {
        ...
        $targetRecord = $query->find('all')->where(['getrecord_id' => $my_id])->all();
