...
class ChangeKwController extends AppController
{
    ...
    var $clientEmailForReport;

    public function generatereport()
    {
        $clients = $this->loadModel('Clients');
        $clientsKeyValue = $this->Clients->find('list', [
            'keyField' => 'client_email', //used to be 'id' but works anyway
        ...
        if ($this->request->is('post')) {
            $clientEmailForReport = $this->request->getData('mail'); //eg "paul@mail.com"
            //debug($clientEmailForReport);
            //$this->report($clientEmailForReport);
            // return $this->redirect(['action' => 'report', $clientEmailForReport]);
            $db = $this->Clients->find('client_email')->$clientEmailForReport;
